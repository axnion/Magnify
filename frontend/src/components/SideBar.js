...
const SideBar = ({
    ...
    updateUnseen,
      ...
      username === null ? undefined : < SideBarItem > < Link
      to = "/profile"
      onClick = {
        updateUnseen
      } >
      ...
      (username === null || role === 'consumer') ? undefined: < SideBarItem > < Link
      to = "/addProduct"
      onClick = {
          updateUnseen
        } >
      ...
      role === 'companyAdmin' ? < SideBarItem > < Link
      to = "/addRep"
      onClick = {
          updateUnseen
        } >
    ...
    /> : undefined }   <
    /SideBarItem > {
    username === null ? < SideBarItem > < Link to = "/login" > < button className = "sidebar-btn" > Log in < /button></Link > < /SideBarItem> : <SideBarItem > <button
